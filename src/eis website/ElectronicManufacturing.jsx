          ...
          <li className="nav-item">
                    ...
                    <div className=" container position-absolute service" /*style="bottom: 0%;  background: rgba(1, 129, 59, 0.85);"*/>
                        <div className="py-4 px-3">
                            <h6 className="section2-content">
                                ...
                                companies specializing in the manufacturing of electronic components
                                and devices. These services cover 
                                the entire lifecycle of electronic products,
                                from design and prototyping to assembly, testing
                            </h6>
                        </div>
                    </div>
                </div>
            ...
            <section id="section_4">
                <div className="container pt-5 ">
                    <div className="row">
                        <div className="col-12 col-sm-12 col-md-12 col-lg-6 mb-5 pe-lg-3  ">
                            <h6 className="row1-heading">Surface Mount Technology (SMT)</h6>
                            <p className="row1-decs my-3" >Surface Mount Technology (SMT) services are a
                                critical aspect of electronic manufacturing
                                that involves the assembly of electronic 
                                components directly onto the surface of 
                                printed circuit boards (PCBs). This method
...
export default ElectronicManufacturing