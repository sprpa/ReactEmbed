...
import P1143581 from "../Images/P1143581 1.png"
import GIC from "../Images/GIC-ISO2015-300x216 3.png"
import GIC_1 from "../Images/GIC-ISO2015-300x216 2.png"
import iqas from "../Images/iqas.png"
import GIC_3 from "../Images/GIC-ISO2015-300x216 7.png"
import GIC_4 from "../Images/GIC-ISO2015-300x216 9.png"
import img from "../Images/1 1.png"
import GIC_5 from "../Images/GIC-ISO2015-300x216 4.png"
                    ...
                    <div className="row ">
                        <div className="col-12 col-lg-6 mb-5 padding" >
                            ...
                            <div className="col-9 my-5">
                                <p className="mb-4">
                                    â€œEmbedded IT Solutions (India) Pvt. Ltd., As A Recognized Electronic Manufacturing Services Solutions From Low Volume
                                    Needs To High End Markets...â€
                                </p>
                        ...
                        <div className="col-12 col-lg-4 npi">
                            <div className="sub_head">
                                ...
                                <p>
                                    ...
                                    partner throughout the entire process â€“ from concept to finished product.
                                </p>
                                <ul>
                        ...
                        <div className="row ">
                            ...
                            <div className="col-12 col-lg-6" >
                                <ul className="two_ul">
                                    ...
                                    <li>Placement accuracy of Â±50Âµ for chips and Â±40Âµ for ICs</li>
                ...
                <div className="container py-5">
                    ...
                    <div className="row ps-lg-5 mt-5 pb-lg-5">
                        <div className="col-12 col-sm-12 col-md-12 col-lg-6">
                            ...
                            <img className="mt-4 px-2 pt-3 pb-5 flex" src={P1143581} alt=""></img>
                    ...
                    <div class="container ms-lg-5 mt-5 py-5" id="logo">
                        <div class="row ">
                            <div class="col-12 col-md-3">
                                <div class="card mb-3 mb-lg-5 bg-transparent border-0">
                                    <div class="card-img-top">
                                        <img src={GIC}  height="94.17px" width="160px" alt=""></img>
                                    </div>
                                ...
                                <div class="card mb-3 mb-lg-5 bg-transparent border-0">
                                    <div class="card-img-top">
                                        <img src={GIC_1} height="94.17px" width="160px" alt=""></img>
                                    </div>
                                    <div class="card-text mt-4">
                            ...
                            <div class="col-12 col-md-3">
                                <div class="card mb-3 mb-lg-5 bg-transparent border-0">
                                    <div class="card-img-top">
                                        <img src={iqas} height="94.17px" width="160px" alt=""></img>
                                    </div>
                                    <div class="card-text mt-4">
                                ...
                                <div class="card mb-3 mb-lg-5 bg-transparent border-0">
                                    <div class="card-img-top">
                                        <img src={GIC_3} height="94.17px" width="160px" alt=""></img>
                                    </div>
                                    <div class="card-text mt-4">
                            ...
                            <div class="col-12 col-md-3">
                                <div class="card mb-3 mb-lg-5 bg-transparent border-0">
                                    <div class="card-img-top">
                                        <img src={GIC_4} height="94.17px" width="160px" alt=""></img>
                                    </div>
                                    <div class="card-text mt-4">
                                ...
                                <div class="card mb-3 mb-lg-5 bg-transparent border-0">
                                    <div class="card-img-top">
                                        <img src={img} height="94.17px" width="160px" alt=""></img>
                                    </div>
                                    <div class="card-text mt-4">
                            ...
                            <div class="col-12 col-md-3">
                                <div class="card mb-5 bg-transparent border-0">
                                    <div class="card-img-top">
                                        <img src={GIC_5} height="94.17px" width="160px" alt=""></img>
                                    </div>
                                    <div class="card-text mt-4">
                ...
                <div className="container">
                    ...
                    <div className="row mt-5">
                        <div className="col-12 col-lg-5 ps-lg-5 pe-lg-5 mb-5">
                            ...
                            <img className="src" src={annual} alt=""></img>
