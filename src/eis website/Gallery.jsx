...
import Group_13767 from "../Images/Group 13767.png"
import Auto_Handler from "../Images/Auto-Handler.png"
import DJI_0747 from "../Images/DJI_0747.png"
import P1143625 from "../Images/P1143625.png"
import P1143638 from "../Images/P1143638.png"
import DJI_0734_copy from "../Images/DJI_0734-copy.png"
import Group_13775 from"../Images/Group 13775.png"
import P1143602 from "../Images/P1143602.png"
import Group_13769 from "../Images/Group 13769.png"
import Group_13771 from "../Images/Group 13771.png"
import X_ray_Unit from "../Images/X-ray-Unit.png"
import P1143609 from "../Images/P1143609.png"
import Laser_marking_Machine from "../Images/Laser-marking-Machine.png"
import Group_13768 from "../Images/Group 13768.png"
import P1143619 from "../Images/P1143619.png"
import Group_13770 from "../Images/Group 13770.png"
import Tape_Reel_machine from "../Images/Tape-_-Reel-machine.png"
import Group_137722 from "../Images/Group 137722.png"
import P1143595 from "../Images/P1143595.png"
import P1143615 from "../Images/P1143615.png"
import P1143623 from "../Images/P1143623.png"
import P1143640 from "../Images/P1143640.png"
        ...
        <div>
            ...
            <header className="py-5">
                <div className="container ">
                    <p>Gallery</p>
                    <h2>Future Ready Infrastructure & Facilities</h2>
                </div>
            </header>

            <section id="gallery_sectionone" className="container-fluid py-5">

                <div>
                    <h4>Gallery</h4>
                    <h2>Infrastructure & Facilities</h2>
                    <p>Facility <span class="text-secondary">Products</span></p>
                </div>
                ...
                <div className="container py-4" >
                    <div className="row mb-1 pb-1">
                        <div className="col-12 col-md-3">
                            <div>
                                <img src={Group_13767} alt="13767" className="img-fluid mb-4 wid"></img>
                            </div>
                            <div>
                                <img src={Auto_Handler} alt="Auto-Handler" className="img-fluid mb-4"></img>
                            </div>
                            <div>
                                <img src={DJI_0747} alt="0747" className="img-fluid mb-4"></img>
                            </div>
                            <div>
                                <img src={P1143625} alt="1253625" className="img-fluid mb-4"></img>
                            </div>
                            <div>
                                <img src={P1143595} alt="1143595" className="img-fluid mb-4"></img>
                            </div>
                            <div>
                                <img src={P1143638} alt="1143638" className="img-fluid mb-4"></img>
                            </div>
                        </div>

                        <div className="col-12 col-md-3">
                            <div>
                                <img src={DJI_0734_copy} alt="13767" className="img-fluid mb-4"></img>
                            </div>
                            <div>
                                <img src={Group_13775} alt="13775" className="img-fluid mb-4"></img>
                            </div>
                            <div>
                                <img src={P1143602} alt="1143602" className="img-fluid mb-4"></img>
                            </div>
                            <div>
                                <img src={Group_13769} alt="13769" className="img-fluid mb-4"></img>
                            </div>
                            <div>
                                <img src={Group_13771} alt="13771" className="img-fluid mb-4"></img>
                            </div>
                            <div>
                                <img src={X_ray_Unit} alt="X-ray-Unit" className="img-fluid mb-4"></img>
                            </div>
                        </div>
                        <div className="col-12 col-md-3">
                            <div>
                                <img src={P1143609} alt="1143609" className="img-fluid mb-4 "></img>
                            </div>
                            <div>
                                <img src={Laser_marking_Machine} alt="Laser-marking-Machine" className="img-fluid mb-4"></img>
                            </div>
                            <div>
                                <img src={Group_13768} alt="13768" className="img-fluid mb-4"></img>
                            </div>
                            <div>
                                <img src={P1143619} alt="1143619" className="img-fluid mb-4"></img>
                            </div>
                            <div>
                                <img src={Group_13770} alt="13770" className="img-fluid mb-4"></img>
                            </div>
                            <div>
                                <img src={Tape_Reel_machine} alt="Tape-_-Reel-machine" className="img-fluid mb-4"></img>
                            </div>

                        </div>
                        <div className="col-12 col-md-3">
                            <div>
                                <img src={Group_137722} alt="137722" className="img-fluid mb-4"></img>
                            </div>
                            <div>
                                <img src={P1143595} alt="1143595" className="img-fluid mb-4"></img>
                            </div>
                            <div>
                                <img src={P1143615} alt="1143615" className="img-fluid mb-4"></img>
                            </div>
                            <div>
                                <img src={P1143623} alt="1143623" className="img-fluid mb-4"></img>
                            </div>
                            <div>
                                <img src={P1143640} alt="1143640" className="img-fluid mb-4"></img>
                            </div>
                        </div>
                    </div>
                </div>
