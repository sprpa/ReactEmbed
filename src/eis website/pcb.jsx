...
function Pcb() {
  ...
  {/* header-1  */}
        ...
        <div className="container-fluid color" >
            <div className="container">
                <div className="col-12 col-lg-12 p-1">
                    <p className="text-uppercase  capabilities">Capabilities</p>
                    <h6 className="one">PCB Assembly & Box Build</h6>
                </div>
            </div>
        </div>
        <div className="col-12 col-md-12 col-sm-12  col-lg-12">
            <div className="d-flex justify-content-center p-5 mt-5 ">
                <div className="container position-absolute bg" >
    ...
    <section className="container-fluid" id="pcb_section-2">
                ...
                <div className="col-12 col-md-6  col-lg-6 p-5 ">
                    <div className="d-flex flex-column  ">
                        <p className=" manufacture p-2 ">
                            Manufacturing practices like Lean and Six Sigma are employed for high mix, low to mid volume
        ...
        {/* < page-3  */}
    <section id="pcb_section-3">

        <div className="container-fluid mt-5 py-5 color3" >

            <p className="p-5 our">OUR SERVICES OFFERINGS</p>
            <p className="eis">PCB Assembly & Box Build offers:</p>
...
{/* page-5 */}
<section className="container-fluid p-5 " id="pcb_section-5">
...
{/* page-6 */}
<section className="container-fluid " id="pcb_section-6">
        <div className="">
...
{/* page-7 */}
<section className="container-fluid position-relative py-5 " id="pcb_section-7">
        <div className="container">
